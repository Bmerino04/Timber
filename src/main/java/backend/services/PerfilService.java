...
public class PerfilService {
    ...
    /**
     * Solicita la edad del usuario y valida que sea un número entero positivo menor
     * a 120.
     *
     * @param scanner El objeto Scanner que se utiliza para capturar la entrada.
    ...
    /**
     * Solicita los pronombres del usuario como una lista de cadenas separadas por
     * comas.
